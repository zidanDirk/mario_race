...
try{
 ...
 await page.screenshot({path:'artifacts/techniques-v1/production-practice.png'});await page.click('#home');await page.click('[data-loadout=drift]');await page.keyboard.press('Escape');await page.click('[data-race-mode=time-trial]');await start();assert.equal(starts[1].rulesVersion,5);assert.equal(starts[1].loadout,'drift');
