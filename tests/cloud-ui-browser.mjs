...
const errors = []; const checks = []; let account = { user: null, stats: null }; let offline = false; let failSave = false; let saves = 0; let tickets = 0; let leader = []; let delayedMe = false;
