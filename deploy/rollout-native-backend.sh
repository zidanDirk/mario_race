...
unset GOOGLE_CLIENT_ID GOOGLE_CLIENT_SECRET GOOGLE_RELAY_URL GOOGLE_RELAY_SECRET
unset EMAIL_SMTP_HOST EMAIL_SMTP_PORT EMAIL_SMTP_SECURE EMAIL_SMTP_USER EMAIL_SMTP_PASSWORD EMAIL_AUTH_SECRET EMAIL_FROM_NAME EMAIL_DAILY_LIMIT
set -a
source "${INCOMING_ENV}"
set +a
